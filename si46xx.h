...
/*
 * example from SDK for v1.0.0 release
 */
#define FLASH_OFFSET_PATCH_016  0x00002000
//#define addr_PATCH_016  0x00004000
#define FLASH_OFFSET_FM         0x00006000
#define FLASH_OFFSET_DAB        0x00086000
#define FLASH_OFFSET_AM		0x00106000
...
int si46xx_set_property(uint16_t property_id, uint16_t data);
...
int si46xx_dab_start_digital_service(uint32_t service_id, uint32_t comp_id);
